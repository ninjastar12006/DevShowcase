    ...
    <div className="min-h-screen bg-white">
        <div className="mx-auto max-w-screen">
            ...
            <div className="grid grid-cols-[repeat(3,400px)] auto-rows-[220px] gap-8 justify-center mx-auto bg-[rgb(0,5,15)] px-12 pt-2 pb-36">
                <div className="flex justify-center bg-slate-700 hover:bg-cyan-600 transition delay-120 duration-500 inset-shadow-sm inset-shadow-[rgb(0,5,15)] rounded-3xl row-span-2">
                    <h1 className="text-6xl text-white content-center">Temp</h1>
                </div>

                <div className="flex justify-center bg-cyan-700 hover:bg-cyan-600 transition delay-120 duration-300 inset-shadow-sm inset-shadow-black rounded-3xl col-span-2">
                    <h1 className="text-6xl text-white content-center">Temp</h1>
                </div>

                <div className="flex justify-center bg-cyan-700 hover:bg-cyan-600 transition delay-120 duration-300 inset-shadow-sm inset-shadow-black rounded-3xl">
                    <h1 className="text-6xl text-white content-center">Temp</h1>
                </div>

                <div className="flex justify-center bg-slate-800 hover:bg-slate-700 transition delay-120 duration-500 inset-shadow-sm inset-shadow-black rounded-3xl">
                    <h1 className="text-6xl text-white content-center">Temp</h1>
                </div>
            </div>
